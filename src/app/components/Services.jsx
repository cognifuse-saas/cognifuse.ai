    ...
    <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <svg className="absolute left-[max(50%,25rem)] top-0 h-[64rem] w-[128rem] -translate-x-1/2 stroke-gray-200 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]" aria-hidden="true">
          ...
          <rect width="100%" height="100%" strokeWidth="0" fill="url(#pattern-id)" />
        </svg>
      </div>
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-700">
                75% of African SMEs close shop every year due to key operational challenges. Discover how our tailored solutions can address these issues and propel your business forward.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          <img className="w-full mt-50 max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10" src="/images/ai-fusion.jpg" alt="AI Solutions for Business" />
        </div>
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>Current solutions are fragmented, causing increased costs and reduced productivity. Our unified platform addresses these pain points with a focus on the African market's unique needs.</p>
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span><strong className="font-semibold text-gray-900">Automated Processes:</strong> Enhance efficiency and accuracy through intelligent automation tools.</span>
                </li>
                <li className="flex gap-x-3">
                  <svg className="mt-1 h-5 w-5 flex-none text-indigo-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              <p className="mt-6">No server? No problem. Our solution adapts to your needs, offering flexibility and scalability without the overhead of traditional server management.</p>
            </div>
          </div>
        </div>
      </div>
